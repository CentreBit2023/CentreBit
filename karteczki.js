...
addBox.addEventListener("click", () => {
    popupTitle.innerText = "Utwórz Nową Notatkę";
    addBtn.innerText = "Dodaj Notatkę";
...
function deleteNote(noteId) {
    let confirmDel = confirm("Czy na pewno chcesz usunąć tą notatkę?");
